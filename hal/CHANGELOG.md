...
## [0.23.0](https://github.com/kyp44/atsamd/compare/atsamd-hal-0.22.2...atsamd-hal-0.23.0) - 2025-11-13
...
- *(ci)* silence deprecation warning we have no power over ([#943](https://github.com/kyp44/atsamd/pull/943))
- *(dmac)* DMAC handler now waits for channel to report as disabled ([#938](https://github.com/kyp44/atsamd/pull/938))
- [**breaking**] Re-add GCLK0 for CAN dependencies ([#930](https://github.com/kyp44/atsamd/pull/930))
- Clippy warning about null pointers in DMAC ([#928](https://github.com/kyp44/atsamd/pull/928))
- Remove GCLK from can::Dependencies ([#919](https://github.com/kyp44/atsamd/pull/919))

### Other

- fix off-by-one Pwm period ([#949](https://github.com/kyp44/atsamd/pull/949))
- Fix and improve EIC Event control ([#944](https://github.com/kyp44/atsamd/pull/944))
- Document order of calling enable_interrupt for interrupt timer ([#942](https://github.com/kyp44/atsamd/pull/942))
